...
epi.sscc(OR = 1.85, p1 = NA, 
         ...
         fleiss = FALSE)$n.total
```

Es necesario 210 casos y 210 controles.
...
epi.sscohortt(irexp1 = 58/317, irexp0 = 60/621, FT = 4, n = NA, 
              ...
              nfractional = FALSE, conf.level = 0.95)$n.total
```

Es necesario 210 de expuestos y 210 no expuestos.
...
epi.sscohortt(irexp1 = 58/317, irexp0 = 60/621, FT = 4, n = 300, 
              ...
              nfractional = FALSE, conf.level = 0.95)$power
```
