...
# 5. `dataframes`
Los dataframes son datos ordenados de una forma estandard, donde las columnas 
(vectores) son variables y las filas son observaciones. 

En r, podemos generar dataframes usando la función data.frame. Realizamos esto
al combinar vectores.
